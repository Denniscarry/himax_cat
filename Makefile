...
CAT_SRCS := \
model/uFire_SHT20.cc \
tensorflow/lite/micro/kernels/arc_mli/scratch_buffers.cc \
tensorflow/lite/micro/kernels/arc_mli/scratch_buf_mgr.cc \
tensorflow/lite/micro/kernels/arc_mli/mli_slicers.cc \
model/himax_we1_evb/detection_responder.cc \
model/himax_we1_evb/image_provider.cc \
model/main.cc \
model/main_functions.cc \
...
CAT_OBJS := \
$(patsubst %.cc,%.o,$(patsubst %.c,%.o,$(CAT_SRCS)))
...
# Common rules
#=============================================================
.PHONY: all person_detection_int8 magic_wand micro_speech cat
...
cat.elf : $(OBJS) $(CAT_OBJS)
	$(CXX) $(CXXFLAGS) -o $@ $(OBJS) $(CAT_OBJS) $(LDFLAGS)

clean:
	@echo 'cleaning'
	-@$(RM) $(OBJS) $(PD_OBJS) $(MW_OBJS) $(MS_OBJS) $(HW_OBJS) $(CAT_OBJS)
	-@$(RM) *.elf
	-@$(RM) *.map
