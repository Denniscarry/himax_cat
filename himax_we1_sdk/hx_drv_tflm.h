...
/**
 * \brief	I2c master control at expansion header. use to set i2c with target ID, target address with data
 *
...
/**
 * \brief	I2c master control connect to accelerometer. use to set i2c with target ID, target address with data
 *
 * \param[in] slave_addr_sft	target device ID represent in 7-bits mode
 * \param[in] addr				target address to set data
 * \param[in] addr_len			target address size in bytes
 ...
 * \retval	HX_DRV_LIB_ERROR	Operation fail
 */
extern HX_DRV_ERROR_E hx_drv_acc_i2cm_set_data(uint8_t slave_addr_sft, uint8_t *addr, uint32_t addr_len, uint8_t *data, uint32_t data_len);

/**
 * \brief	I2c master control connect to accelerometer. use to read i2c data with target ID
 *
 * \param[in] slave_addr_sft	target device ID represent in 7-bits mode
 * \param[in] addr				target address to read data
 * \param[in] addr_len			target address size in bytes
 ...
 * \retval	HX_DRV_LIB_ERROR	Operation fail
 */
extern HX_DRV_ERROR_E hx_drv_acc_i2cm_get_data(uint8_t slave_addr_sft, uint8_t *addr, uint32_t addr_len, uint8_t *data, uint32_t data_len);
